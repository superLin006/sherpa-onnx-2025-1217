...
class OfflineRecognizerSenseVoiceSophonImpl : public OfflineRecognizerImpl {
 public:
  explicit OfflineRecognizerSenseVoiceSophonImpl(
      const OfflineRecognizerConfig &config)
      : OfflineRecognizerImpl(config),
        config_(config),
        symbol_table_(config_.model_config.tokens),
        model_(std::make_unique<OfflineSenseVoiceModelSophon>(
            config.model_config)) {
  ...
  OfflineRecognizerSenseVoiceSophonImpl(Manager *mgr,
                                        const OfflineRecognizerConfig &config)
